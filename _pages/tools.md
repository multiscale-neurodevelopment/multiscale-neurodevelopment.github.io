...
![]({{ site.url }}{{ site.baseurl }}/images/cortpro.png){: style="width: 250px; float: center; margin: 0px  10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/slider/bigbrainwarp.png){: style="width: 250px; float: center; margin: 0px  10px"}
